...
import com.payu.baas.core.databinding.ActivityReloginBinding
...
class ReloginActivity : BaseActivity() {
    ...
    lateinit var reLoginBaseCallback: BaseCallback
                    ...
                    ApiName.SEND_OTP -> {
                        it.data?.let {
                            if (it is SendOtpResponse) {
                                    if ((it as com.payu.baas.core.model.responseModels.SendOtpResponse).message.equals(
                                            com.payu.baas.core.util.BaaSConstantsUI.OTP_SENT)) {
