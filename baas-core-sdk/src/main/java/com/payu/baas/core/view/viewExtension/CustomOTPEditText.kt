...
class CustomOTPEditText: EditText {
    ...
    fun setCustomFont(context: Context?, fontPath: String?): Boolean {
        val typeface: Typeface? =
            com.payu.baas.core.view.viewExtension.FontCache.getTypeface(context!!, fontPath!!)
...
//        this.setTextSize(getResources().getDimension(R.dimen.button_text_size));
        this.setBackground(getResources().getDrawable(R.drawable.otp_background,
            resources.newTheme()))
