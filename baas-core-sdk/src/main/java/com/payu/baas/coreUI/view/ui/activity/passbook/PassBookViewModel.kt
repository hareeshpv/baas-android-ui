...
internal class PassBookViewModel(
    ...
    init {
        ...
        selectedTimePeriodType = com.payu.baas.coreUI.model.datasource.PassBookFilterDataSource.timePeriodTypes[0]
        appliedTimePeriodO.set(com.payu.baas.coreUI.model.datasource.PassBookFilterDataSource.timePeriodTypes[0].label)

        //Default Selected Transaction Type as 'All'
        selectedTransactionType = com.payu.baas.coreUI.model.datasource.PassBookFilterDataSource.transactionTypes[0]
        //Default Selected Account Type as 'All'
        selectedAccountType = com.payu.baas.coreUI.model.datasource.PassBookFilterDataSource.accountTypes[0]
    ...
    fun applyTimePeriodSelectionFilter() {
        selectedTimePeriodType?.let {
            if (it.label == com.payu.baas.coreUI.model.datasource.PassBookFilterDataSource.CUSTOM_TIME_PERIOD) {
    ...
    fun applyFilter() {
        ...
        selectedTransactionType?.let {
            if (it.label != com.payu.baas.coreUI.model.datasource.PassBookFilterDataSource.ALL)
                appliedFilterCount++
        }
            ...
            viewModelScope.launch {
                ...
                try {
                    ...
                    selectedAccountType?.let { type ->
                        if (type.code != com.payu.baas.coreUI.model.datasource.PassBookFilterDataSource.ALL) {
