...
import com.payu.baas.coreUI.databinding.LayoutPassbookFiltersBinding
...
class PassBookFilterBottomDialogFragment : BottomSheetDialogFragment() {
    ...
    private fun setupUI() {
        ...
        val transactionTypeList = com.payu.baas.coreUI.model.datasource.PassBookFilterDataSource.transactionTypes
        ...
        //Set previously selected type
        val accountTypeList = com.payu.baas.coreUI.model.datasource.PassBookFilterDataSource.accountTypes
