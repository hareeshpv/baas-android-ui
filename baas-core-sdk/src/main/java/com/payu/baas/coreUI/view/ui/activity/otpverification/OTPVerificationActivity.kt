package com.payu.baas.coreUI.view.ui.activity.otpverification
...
class OTPVerificationActivity : BaseActivity() {
    ...
    private fun otpConvertAstric() {
        binding.enterOtp1.transformationMethod =
            com.payu.baas.coreUI.util.AsteriskPasswordTransformationMethod()
        binding.enterOtp2.transformationMethod =
            com.payu.baas.coreUI.util.AsteriskPasswordTransformationMethod()
        binding.enterOtp3.transformationMethod =
            com.payu.baas.coreUI.util.AsteriskPasswordTransformationMethod()
        binding.enterOtp4.transformationMethod =
            com.payu.baas.coreUI.util.AsteriskPasswordTransformationMethod()
        ...
        when {
            binding.enterOtp1.text.toString().isEmpty() -> {
                binding.enterOtp1.background =
                    ContextCompat.getDrawable(this, R.drawable.otp_white_border_view)
                binding.enterOtp1.requestFocus()
                binding.enterOtp1.isCursorVisible = true

                binding.enterOtp2.background =
                    ContextCompat.getDrawable(this, R.drawable.otp_background)
