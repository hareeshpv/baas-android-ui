...
import com.payu.baas.coreUI.databinding.ActivityChangeTransactionLimitsBinding
    ...
    private fun setupUI() {
        ...
        if (intent.extras!!.containsKey(BaaSConstantsUI.BS_KEY_TRANSACTION_LIMIT_VALUES)) {
            ...
            var transactionLimits =
                com.payu.baas.coreUI.util.JsonUtil.toObject(transactionLimitsString, TransactionLimitModel::class.java)
