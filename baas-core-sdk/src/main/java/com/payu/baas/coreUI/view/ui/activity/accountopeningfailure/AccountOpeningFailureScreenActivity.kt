package com.payu.baas.coreUI.view.ui.activity.accountopeningfailure
...
//        setupObserver()
    ...
    private fun setupUI() {
        ...
        var strPanDetails =
            SessionManagerUI.getInstance(this).userPanDetails
        if (!strPanDetails.isNullOrEmpty()) {
            var panDetails =
                com.payu.baas.coreUI.util.JsonUtil.toObject(strPanDetails, com.payu.baas.coreUI.model.entities.model.PanDetailsModelUI::class.java) as com.payu.baas.coreUI.model.entities.model.PanDetailsModelUI
