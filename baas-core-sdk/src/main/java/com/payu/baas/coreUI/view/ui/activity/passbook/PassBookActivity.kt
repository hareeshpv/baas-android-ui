...
import com.payu.baas.coreUI.databinding.ActivityPassbookBinding
...
internal class PassBookActivity : BaseActivity(), ClickHandler {
                            ...
                            if (it is GetPassBookTransactionsResponse) {
                                if (it.transactionList.isNotEmpty()) {
                                    ...
                                    val finalTransactionList =
                                        arrayListOf<com.payu.baas.coreUI.model.entities.model.GetPassBookTransactionDetailHeader>()
                                            ...
                                            transactionDate?.let {
                                                ...
                                                if (finalTransactionList.isNotEmpty()) {
                                                    ...
                                                    if (!foundMatch) {
                                                        ...
                                                        val header =
                                                            com.payu.baas.coreUI.model.entities.model.GetPassBookTransactionDetailHeader()
                    ...
                    if (it.message.contains(BaaSConstantsUI.INVALID_ACCESS_TOKEN) || it.message!!.contains(
                        ...
                        try {
                            ...
                            if (errorResponse.errorCode >= BaaSConstantsUI.TECHINICAL_ERROR_CODE
                                ...
                                var msg = ""
                                try {
                                    val errorUiRes = com.payu.baas.coreUI.util.JsonUtil.toObject(
                                        it.message,
    ...
    private fun IsDefaultFilterValueApplied(): Boolean {
        if (viewModel.selectedTimePeriodType?.code == com.payu.baas.coreUI.model.datasource.PassBookFilterDataSource.ALL_TIME
            && viewModel.selectedAccountType?.code == com.payu.baas.coreUI.model.datasource.PassBookFilterDataSource.ALL
            && viewModel.selectedTransactionType?.code == com.payu.baas.coreUI.model.datasource.PassBookFilterDataSource.ALL
        ) {
            return true
        }
        return false
