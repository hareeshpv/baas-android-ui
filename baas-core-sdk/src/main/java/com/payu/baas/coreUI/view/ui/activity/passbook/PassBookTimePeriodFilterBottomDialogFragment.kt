...
class PassBookTimePeriodFilterBottomDialogFragment : BottomSheetDialogFragment(),
    ...
    private fun setupUI() {
        ...
        val list = com.payu.baas.coreUI.model.datasource.PassBookFilterDataSource.timePeriodTypes
        ...
        if (viewModel.selectedTimePeriodType?.code == com.payu.baas.coreUI.model.datasource.PassBookFilterDataSource.CUSTOM_TIME_PERIOD) {
                ...
                selectedTypeModel?.let {
                    ...
                    if (it.label == com.payu.baas.coreUI.model.datasource.PassBookFilterDataSource.CUSTOM_TIME_PERIOD) {
                        ...
                        if (strStartDate.isEmpty()) {
                            com.payu.baas.coreUI.app.BaasUIApp.ctx?.let { act ->
